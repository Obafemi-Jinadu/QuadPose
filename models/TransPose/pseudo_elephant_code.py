"""Legacy TransPose elephant pseudo-label script.
...
def main() -> None:
    ...
    parser.parse_args()
    raise SystemExit(
        "models/TransPose/pseudo_elephant_code.py is a legacy script and is "
        "not production-ready. Use scripts/quadpose_vitpose_demo.py for "
        "inference or port this workflow to an argument-driven pseudo-label CLI."
    )
