...
model = dict(
    type='TopDown',
    pretrained='small_pretrained.pth',
    backbone=dict(
        type='ViT',
        img_size=(256, 192),
        patch_size=16,
...
data = dict(
    ...
    train2=[
        ...
        dict(
        type='ElephantDataset',
        ann_file=f'./{data_root}/elephant_pseudo/annotations/pseudo_elephant_keypoints_s.json',
        ...
        dataset_info=dataset_info1),
         ...
         dict(
        type='AnimalPoseDataset',
        ann_file=f'./{data_root}/ap-60k_pseudos/annotations/pseudo_others_keypoints_s.json',
