...
lr_config = dict(
    ...
    warmup_iters=500,
    warmup_ratio=0.001,
    step=[18,400, 450])   #step=[18,400, 450]) changed [18,335, 450]
total_epochs = 500
log_config = dict(
    interval=1,
    hooks=[
...
#print("data info: ",_base_.dataset_info )
data_root = 'data'
data = dict(
    samples_per_gpu=32,
    workers_per_gpu=4,
    ...
    train2=[
        ...
        dict(
        type='ElephantDataset',
        ann_file=f'./{data_root}/elephant_pseudo/annotations/pseudo_elephant_keypoints.json',
        img_prefix=f'./{data_root}/elephant_pseudo/data/train2017/',
        data_cfg=data_cfg,
        pipeline=train_pipeline,
        dataset_info={{_base_.dataset_info}}),
         ...
         dict(
        type='ElephantDataset',
        ann_file=f'./{data_root}/elephant_pseudo_hard/annotations/pseudo_elephant_keypoints_hard.json',
        img_prefix=f'./{data_root}/elephant_pseudo_hard/data/train2017/',
        data_cfg=data_cfg,
        pipeline=train_pipeline,
        dataset_info={{_base_.dataset_info}}),
        ...
        dataset_info=dataset_info1),
         ...
         dict(
        type='AnimalPoseDataset',
        ann_file=f'./{data_root}/ap-60k_pseudos/annotations/pseudo_others_keypoints.json',
        img_prefix=f'./{data_root}/ap-60k_pseudos/data/train2017/',
        data_cfg=data_cfg2,
        pipeline=train_pipeline,
        dataset_info=dataset_info1),
